...
describe('getCid extraction', () => {
  ...
  it('extracts CID from nested original structure (from logs)', () => {
    const input = {
      ...
      original: {
        $type: "blob",
        ref: { $link: "bafkreigbpcsylct4vguz6dnvq6drop3ipktp6ppgx4glw6zarimppfxehy" },
        mimeType: "image/jpeg",
        size: 384452
      }
    }
    expect(getCid(input as unknown as Parameters<typeof getCid>[0])).toBe("bafkreigbpcsylct4vguz6dnvq6drop3ipktp6ppgx4glw6zarimppfxehy")
  })
  ...
  it('extracts CID from original.ref when it is a direct string', () => {
    ...
    expect(getCid(input as unknown as Parameters<typeof getCid>[0])).toBe("bafkrei-original-string")
  })
  ...
  it('extracts CID from full post structure provided in issue', () => {
    ...
    expect(getCid(image as unknown as Parameters<typeof getCid>[0])).toBe("bafkreigbpcsylct4vguz6dnvq6drop3ipktp6ppgx4glw6zarimppfxehy")
  })
  ...
  it('extracts CID when nested under image property', () => {
    ...
    expect(getCid(input as unknown as Parameters<typeof getCid>[0])).toBe("bafkrei-nested-image")
  })
  ...
  it('extracts CID from image property when it is a direct string', () => {
    ...
    expect(getCid(input as unknown as Parameters<typeof getCid>[0])).toBe("bafkrei-image-string")
  })
  ...
  it('extracts CID from ref property when it is a direct string', () => {
    ...
    expect(getCid(input as unknown as Parameters<typeof getCid>[0])).toBe("bafkrei-ref-string")
  })

  it('returns undefined when no CID is found', () => {
    expect(getCid({})).toBeUndefined()
    expect(getCid({ something: 'else' } as unknown as Parameters<typeof getCid>[0])).toBeUndefined()
  })
})
