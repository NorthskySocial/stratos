    ...
    "main": {
      ...
      "record": {
        ...
        "properties": {
          ...
          "signingKey": {
            "type": "string",
            "description": "The user's public key as a did:key string, used for user-level record signing. For 'stratos' custody this is a P-256 key generated by the Stratos service; for 'pds' custody this is the user's own '#atproto' key from their DID document."
          },
          "attestation": {
            "type": "ref",
          ...
          "custody": {
            "type": "string",
            "description": "Who hosts and signs this enrollment's repo. 'stratos' is the Stratos-hosted, Stratos-signed repo. 'pds' is the user's own spaces-capable PDS, signing with their own '#atproto' key. Defaults to 'stratos' when absent.",
            "knownValues": ["stratos", "pds"]
          },
          "repoHost": {
            "type": "string",
            "format": "uri",
            "description": "The repo host endpoint when custody is 'pds'. Absent for 'stratos' custody."
          }
        }
      }
    },
      ...
      "output": {
        ...
        "schema": {
          ...
          "properties": {
            ...
            "cursor": {
              "type": "string",
              "description": "Pass to the next call to continue. Absent on the last page."
            }
          }
        }
      }
