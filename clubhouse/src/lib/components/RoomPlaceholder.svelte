...
<section class="room-view" aria-labelledby="room-title">
  ...
  <div class="room-view-heading">
    <span
      class={`room-icon room-view-icon room-icon-${visual.tone}`}
      aria-hidden="true"><IconaMoon name={visual.icon} /></span
    >
    <div>
  ...
  {#if state === 'loading'}
    <p class="feed-status" aria-busy="true">Checking room access…</p>
  ...
  {:else if state === 'pending'}
    <div class="placeholder-panel">
      ...
      <div>
        ...
        <p>
          Enrollment is finishing in the background. You can return here when
          the room is ready.
        </p>
        <button
  ...
  {:else if state === 'unavailable'}
    <div class="placeholder-panel">
      ...
      <div>
        ...
        <p>
          Its posts remain available only to people who already joined. Return
          to the room list to explore another open membership area.
        </p>
      </div>
    </div>
  {:else if state === 'status-error'}
    <div class="placeholder-panel">
      ...
      <div>
        ...
        <p>
          We could not verify whether you are already a member. You can still
          start the room’s secure enrollment flow.
        </p>
        <button
          class="button button-primary"
          type="button"
          onclick={() => onJoin(room.id)}>Join room</button
        >
      </div>
    </div>
  {:else}
    <div class="placeholder-panel">
      ...
      <div>
        ...
        <p>
          This is an open membership area. Joining starts the room’s enrollment
          flow; the interface state is only a guide, not access control.
        </p>
        <button
          class="button button-primary"
          type="button"
