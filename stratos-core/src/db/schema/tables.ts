 ...
 */
export const stratosRepoBlock = sqliteTable('stratos_repo_block', {
 ...
 */
export const stratosRecord = sqliteTable('stratos_record', {
 ...
 */
export const stratosBlob = sqliteTable('stratos_blob', {
  cid: text('cid').primaryKey(),
  ...
  index('stratos_blob_tempkey_idx').on(table.tempKey),
])

/**
 * Stratos record-blob association table
 */
export const stratosRecordBlob = sqliteTable('stratos_record_blob', {
 ...
 */
export const stratosBacklink = sqliteTable('stratos_backlink', {
 ...
 */
export const stratosSeq = sqliteTable('stratos_seq', {
